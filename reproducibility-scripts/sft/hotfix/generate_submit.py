...
hyper_params = {
    "apertus-8b": {
        "checkpoint": "Apertus8B-tokens7.2T-it1728000",
...
for model in models:
    ...
    for dataset in datasets:
        ...
        job_id = f"{hp['checkpoint']}-{dataset}-bs{batch_size}-lr{hp['learning_rate']}-maxgnorm{hp['learning_rate']}-epochs{hp['num_epochs']}"
