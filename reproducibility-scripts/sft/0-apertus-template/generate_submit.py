...
# Prefix under the parent directory of this script in reproducibility scripts.
stdout_prefix = "some-sub-experiment"
stdout_root = (
...
for model in models:
    for dataset in datasets:
        ...
        # Adjust the job id depending on what you're ablating on.
        job_id = f"{hp['checkpoint']}-{dataset}-bs{batch_size}-lr{hp['learning_rate']}-epochs{hp['num_epochs']}-{hp['optimizer']}"
