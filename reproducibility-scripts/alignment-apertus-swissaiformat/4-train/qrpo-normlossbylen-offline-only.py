...
stdout_prefix = "qrpo-normlossbylen"
stdout_root = (
                        ...
                        for lr in learning_rates:
                            for beta in betas[loss]:
                                ...
                                for train_num_ref_rewards in train_num_ref_rewards_list:
                                    jobid = f"{dataset_with_ref_rewards}-{loss}-numref{train_num_ref_rewards}-lr{lr}-beta{beta}-normloss"
                                    ...
                                    commands.append(
                                        (
                                            ...
                                            f"training_args.normalize_loss_by_length=true "
