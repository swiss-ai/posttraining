...
BASE_DIR="/iopsstor/scratch/cscs/dmelikidze/dmelikidze/projects/posttraining/run/artifacts/private/outputs/train_preference/maxmin-apertus1-8b-sweep"
OUTPUT_DIR="/iopsstor/scratch/cscs/dmelikidze/aper_mods9"
