...
models = ["apertus-8b-sft-1.5--lr8e-5"]
model_hps = {
    # "apertus-70b-sft": {
    #     "ids_paths": [
    #         (
    ...
    # "apertus-8b-sft-1.5--lr8e-6": {
    #     "ids_paths": [ # Important
    #         (
    #             "apertus-8b-sft-1.5--lr8e-6",
    #             "/iopsstor/scratch/cscs/dmelikidze/sft-models/ap-1p5-cooldown-sft-21-04-lr-8e-6",
    #         ),
    #     ],
    #     "batch_size": 128,
    #     "num_nodes_per_job": 4,
    ...
    #     "accelerate_config": "src/post_training/configs/accelerate/ds-zero2.yaml",
    # },
    # "apertus-8b-sft-1.5--lr1e-5": {
    #     "ids_paths": [ # Important
    #         (
    #             "Apertus-8B-Instruct-2509-SFT",
    #             "/iopsstor/scratch/cscs/dmelikidze/sft-models/ap-1p5-cooldown-sft-21-04-lr-1e-5",
    #         ),
    #     ],
    #     "batch_size": 128,
    #     "num_nodes_per_job": 4,
    ...
    #     "accelerate_config": "src/post_training/configs/accelerate/ds-zero2.yaml",
    # },
    # "apertus-8b-sft-1.5--lr5e-5": {
    #     "ids_paths": [ # Important
    #         (
    #             "Apertus-8B-Instruct-2509-SFT",
    #             "/iopsstor/scratch/cscs/dmelikidze/sft-models/ap-1p5-cooldown-sft-21-04-lr-5e-5",
    #         ),
    #     ],
    #     "batch_size": 128,
    #     "num_nodes_per_job": 4,
    ...
    "apertus-8b-sft-1.5--lr8e-5": {
        "ids_paths": [ # Important
        # so these models have pad token 3, inside their tokenizer_config.yaml, so set your pad tokens to 3 as well.
            (
                "Apertus-8B-Instruct-2509-SFT",
    ...
    "apertus-0.6b-sft-1.5--lr8e-5": {
        "ids_paths": [ # Important
            (
                "Apertus-8B-Instruct-2509-SFT",
                "/iopsstor/scratch/cscs/dmelikidze/ap_mo/distilled/apertus-0.6b-sft-1.5--lr8e-5--DPO-1.5",
            ),
        ],
        "batch_size": 128,
        "num_nodes_per_job": 8,
    ...
    "apertus-1.7b-sft-1.5--lr8e-5": {
        "ids_paths": [ # Important
            (
                "Apertus-8B-Instruct-2509-SFT",
                "/iopsstor/scratch/cscs/dmelikidze/ap_mo/distilled/apertus-1.7b-sft-1.5--lr8e-5--DPO-1.5",
            ),
        ],
        "batch_size": 128,
        "num_nodes_per_job": 8,
    ...
    "apertus-3.0b-sft-1.5--lr8e-5": {
        "ids_paths": [ # Important
            (
                "Apertus-8B-Instruct-2509-SFT",
                "/iopsstor/scratch/cscs/dmelikidze/ap_mo/distilled/apertus-3.0b-sft-1.5--lr8e-5--DPO-1.5",
            ),
        ],
        "batch_size": 128,
        "num_nodes_per_job": 8,
