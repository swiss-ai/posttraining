...
def main(args):
    ...
    decontamination_prompts.save_to_disk(args.save_path)


if __name__ == "__main__":
    """
    python gather_decontamination_prompts.py --save_path="/capstor/store/cscs/swissai/infra01/posttrain_data/04_decontaminated/decontamination_prompts"
    """
