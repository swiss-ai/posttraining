...
CHAT_TEMPLATES = {
    ...
    # '<s><SPECIAL_61><SPECIAL_62><SPECIAL_65>What is 2 + 2?<SPECIAL_66><SPECIAL_67>The result is 4</s>'
    "apertus": (
        ...
        "    {{ developer_token }}"
        "    {%- if \"text\" in developer_content -%}"
        "        {{ developer_content.text + '\n' }}"
        "    {%- endif -%}"
        "    {%- if \"formatted_tools\" in developer_content -%}"
        ...
        "                    {{ tool_calls_token + '[' }}"
        "                    {%- for tool_call in block.content -%}"
        ...
        "                    {{ '[' }}"
        "                    {%- for tool_output in block.content -%}"
        "                        {{- tool_output.output }}"
        "                        {%- if not loop.last -%}"
        "                            {{- \", \" }}"
        "                        {%- endif -%}"
        ...
        "                        {{ outer_token }}"
        "                    {%- endif -%}"
        "                    {{ answers_token + block.content|tojson }}"
        "                {%- endif -%}"
        "            {%- endfor -%}"
        "        {%- else -%}"
