...
enroot import docker://registry.rcp.epfl.ch#claire/moalla/swiss-alignment:arm64-cuda-root-latest
...
apptainer pull docker://registry.rcp.epfl.ch/claire/moalla/swiss-alignment:arm64-cuda-root-latest
```
...
```bash
cd installation/docker-arm64-cuda/EPFL-SCITAS-setup/submit-scripts
bash minimal.sh
```
